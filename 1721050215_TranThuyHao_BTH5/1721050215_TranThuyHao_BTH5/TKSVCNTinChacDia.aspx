<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TKSVCNTinChacDia.aspx.cs" Inherits="_1721050215_TranThuyHao_BTH5.TKSVCNTinChacDia" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="border: 2px solid blue; margin-top: 7px;">
        <header class="w3-container" style="padding-top: 22px">
            <h5><b><i class='fas fa-stream'></i>Thống kê sinh viên chuyên ngành Tin Trắc Địa</b></h5>
        </header>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="MaSV" DataSourceID="SqlDataSource_TinChacDia">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource_TinChacDia" runat="server" ConnectionString="<%$ ConnectionStrings:DB_DATNConnectionString %>" SelectCommand="SELECT tbl_sinhvien.MaSV, tbl_sinhvien.TenSV, tbl_sinhvien.NamSinh, (CASE GioiTinh WHEN 'true' THEN N'Nam' WHEN 'false' THEN N'Nữ' END) AS Expr1, tbl_sinhvien.Khoa, tbl_chuyennganh.TenCN, tbl_sinhvien.Email, tbl_sinhvien.DienThoai, tbl_sinhvien.DiaChi FROM tbl_sinhvien INNER JOIN tbl_chuyennganh ON tbl_sinhvien.ChuyenNganh = tbl_chuyennganh.MaCN WHERE (tbl_chuyennganh.MaCN = @mcn)">
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="mcn" />
            </SelectParameters>
        </asp:SqlDataSource>
