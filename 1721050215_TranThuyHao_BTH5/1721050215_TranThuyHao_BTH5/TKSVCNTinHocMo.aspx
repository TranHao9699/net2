<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TKSVCNTinHocMo.aspx.cs" Inherits="_1721050215_TranThuyHao_BTH5.TKSVCNTinHocMo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="border: 2px solid blue; margin-top: 7px;">
        <header class="w3-container" style="padding-top: 22px">
            <h5><b><i class='fas fa-stream'></i>Thống kê sinh viên chuyên ngành mỏ</b></h5>
        </header>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DB_DATNConnectionString %>" SelectCommand="SELECT tbl_sinhvien.MaSV, tbl_sinhvien.TenSV, tbl_sinhvien.NamSinh, (CASE GioiTinh WHEN 'true' THEN N'Nam' WHEN 'false' THEN N'Nữ' END) AS Expr1, tbl_sinhvien.Khoa, tbl_chuyennganh.TenCN, tbl_sinhvien.Email, tbl_sinhvien.DienThoai, tbl_sinhvien.DiaChi FROM tbl_sinhvien INNER JOIN tbl_chuyennganh ON tbl_sinhvien.ChuyenNganh = tbl_chuyennganh.MaCN WHERE (tbl_chuyennganh.MaCN = @mcn)">
            <SelectParameters>
                <asp:Parameter DefaultValue="1" Name="mcn" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataCNTinHocMo" runat="server"></asp:SqlDataSource>
    </div>
</asp:Content>
